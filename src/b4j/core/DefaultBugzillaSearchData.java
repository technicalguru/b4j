...
/**
 * Default implementation of BugzillaSearchData. This class can
 * read it's parameters and values from a configuration object.
 * @author Ralph Schuster
 *
 */
public class DefaultBugzillaSearchData implements BugzillaSearchData {
	 ...
	 * Default constructor.
	 */
	public DefaultBugzillaSearchData() {
	...
	public void configure(Configuration config) throws ConfigurationException {
		...
		while (keys.hasNext()) {
			...
			while (values.hasNext()) add(key, values.next().toString());
		}
	}
